...
Alternatively, if you would like fine-grained control over the renoun Web Socket server, you can create it manually in your project's `next.config.js` file:
