...
import { createCollection, type SourceOf } from 'renoun'
...
import { createCollection } from 'renoun'
...
export const Components = createCollection<Schema>(
...
```tsx
import { createCollection, Tokens } from 'renoun'
