...
│   ├── layout.tsx
│   └── page.tsx
├── posts/                  # Content directories for user content
...
Without this, the directory won't exist when users install your template from npm, and their
content won't be merged into it.
