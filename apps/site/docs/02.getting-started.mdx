...
When creating a collection for the first time, a dynamic import will be
generated at the collection's call site during the development or build
process. This import is necessary to load the collection's targeted files from
the file system.
