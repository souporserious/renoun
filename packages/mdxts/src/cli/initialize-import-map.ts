...
function initializeImportMap(
  ...
  const currentImportMap = existsSync(`${PACKAGE_DIRECTORY}/index.js`)
    ? readFileSync(`${PACKAGE_DIRECTORY}/index.js`, 'utf-8')
    : null
  const nextImportMap = [
  ...
  writeFileSync(`${PACKAGE_DIRECTORY}/index.js`, nextImportMap)
}
