...
const workingDirectory = '/Users/username/Code/omnidoc/site'
...
describe('filePathToUrlPathname', () => {
  ...
  it('uses directory for readme', () => {
    expect(filePathToPathname('omnidoc/src/components/readme.md')).toBe(
      '/omnidoc/src/components'
    )
  ...
  it('normalizes relative paths', () => {
    expect(
      filePathToPathname(
        resolve(
          workingDirectory,
          '../packages/omnidoc/src/components/index.ts'
        ),
        '../packages/omnidoc/src'
      )
    ).toBe('/components')
  })
  ...
  it('handles base directory, base pathname, and package name', () => {
    expect(
      filePathToPathname(
        resolve(workingDirectory, '../packages/omnidoc/src/index.ts'),
        '../packages/omnidoc/src',
        'packages',
        'omnidoc'
      )
    ).toBe('/packages/omnidoc')
  })
