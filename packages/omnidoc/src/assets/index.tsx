...
/**
 * The logo mark of the Omnidoc library.
 * @internal
 */
...
/**
 * The logo of the Omnidoc library.
 * @internal
 */
...
/**
 * A component that displays the Omnidoc logo that links to the Omnidoc website.
 * @internal
 */
...
/**
 * A component that displays a "Built with Omnidoc" message.
 * @internal
 */
