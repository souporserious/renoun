...
const configPath = resolve(process.cwd(), '.renoun/config.json')
const defaultConfig = {
  theme: 'nord',
  gitBranch: process.env.RENOUN_GIT_BRANCH || 'main',
  gitSource: process.env.RENOUN_GIT_SOURCE,
  gitProvider: process.env.RENOUN_GIT_PROVIDER as any,
