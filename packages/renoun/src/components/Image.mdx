...
You can also include a raw Figma file ID directly in the `figma:` URL instead of an alias:

```tsx
// Using a component name with a raw file ID
<Image source="figma:KsxguDdVW4EQ0oQz0CMNeg/arrow-down" />

// Using a node id with a raw file ID
<Image source="figma:KsxguDdVW4EQ0oQz0CMNeg/915:1075" />
```
