...
Examples can be rendered in MDX using the `Example` component. This component takes a `source` prop, which is the name of the example file or code block in any of the [locations examples can exist](./01.writing.mdx).
