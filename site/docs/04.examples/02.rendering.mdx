...
For this, you can lean on your specific framework to handle templating and querying the metadata collected from `createDataSource`. Using Next.js as an example framework, we can create a custom page that will render the example based on the name of the example file:
