...
MDXTS generates a graph of prose content, type documentation, and examples
that can be rendered through components and utilities using [React 18 Server
...
The CLI tool is the quickest way to get started using MDXTS. Run the following command in the root of your Next.js project to walk through configuring the plugin and rendering a data source:
...
Alternatively, you can follow the manual setup guide to configure the plugin and define a data source in your Next.js project.
