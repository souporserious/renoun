...
MDXTS is a collection of components and utilities for rendering content, type documentation, and code examples
using [React Server
...
This is useful for showing incomplete or incorrect code examples in documentation for educational purposes. Read more about [type checking](/type-checking) to learn how the TypeScript compiler is used for providing type information for code blocks.
...
When collecting information about a TypeScript source file (`Button.tsx` in this case), the examples will be included in the metadata. Read more about [examples](/examples/authoring) to learn how to generate interactive documentation and render them to a route.
