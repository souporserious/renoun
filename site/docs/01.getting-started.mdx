...
This is useful for showing incomplete or incorrect code examples in documentation for educational purposes. Read more about [type checking](./03.type-checking.mdx) to learn how the TypeScript compiler is used for providing type information for code blocks.
